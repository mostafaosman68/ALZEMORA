...
speak_cooldown = 3.0  # Only announce the same object again after this many seconds
...
# Initialize webcam
video_capture = cv2.VideoCapture("http://172.20.10.3:81/stream", cv2.CAP_FFMPEG)
